...
def get_dataset(
    ...
    for task in tasks:  # for each task
        ...
        data_path_train = f"/home/zxp/projects/C2F_bi_equi/fourier_data/train/{task}/variation0/episodes"
        data_path_val = f"/home/zxp/projects/C2F_bi_equi/fourier_data/val/{task}/variation0/episodes"
